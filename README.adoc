...
:page-seo-description: A getting started tutorial and an example on how to build and test a Java web application with a Gradle build configuration script using the Gradle War plug-in and Open Liberty Gradle plug-in.
