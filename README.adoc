...
By default, when the [hotspot42-54 file=1]`liberty` and the [hotspot=56-58 file=1]`war` 
...
dependencies. The Apache `commons-httpclient` and `junit` dependencies are needed to compile 
and run the integration test [hotspot=10-35 file=0]`EndpointIT` class.
...
[source, Java, linenums, role='code_column']
----
include::finish/src/main/java/io/openliberty/guides/hello/HelloServlet.java[tag=**]
----
