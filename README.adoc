...
The [hotspot=liberty file=1]`liberty` ext ension configures the Liberty server, which includes the following settings:
[cols="40, 100"]
|===
...
So what's not configured for the [hotspot=liberty file=1]`liberty` plug-in?
