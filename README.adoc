...
[hotspot=1-30 file=2]`src/main/java/io/openliberty/guides/hello/HelloServlet.java` file 
...
[hotspot=1-30 file=1]`src/main/java/io/openliberty/guides/hello/HelloServlet.java` file 
